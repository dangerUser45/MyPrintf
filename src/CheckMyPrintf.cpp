...
int main ()
{
     MyPrintf ("%s %b %s %s\n", "I want to BAICKAL Electronics", 0b1001, "QWERTYshackal", "I have repository OIP");
       MyPrintf ("%b %s", 0b100100100100100100, "Hi My\n");

     MyPrintf ("\n\t\t\t\t" YELLOW "My printf ():" RESET "\n"
            "\t\t\tZero     arg: " GREEN "%s" RESET "\n"
            ...
            "\t\t\tEigth    arg: " GREEN "%b" RESET "\n\n", "Hi! My", 0x34, 01234567, 0b100100100100, 65, 25, 0xDED, 33, 0b1010);
     ...
     MyPrintf ("%s", "I love your mom very strong and I not want go to English tomorrow\n");
